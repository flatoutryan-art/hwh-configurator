...
export default function App() {
  ...
  function canvasDrop(e) {
    ...
    const nu    = { id:idRef.current++, type:c.type, width:c.width, height:c.height, xMm:xSnap, finish:DEFAULT_FINISH, hardware:DEFAULT_HW, hinge:DEFAULT_HINGE, runner:DEFAULT_RUNNER, rotation:0 };
    setUnits(p => [...p, nu]);
    setSelected(nu.id);
  }
