                  ...
                  <div style={{ paddingTop:10, borderTop:`1px solid ${C.border}33` }}>
                    ...
                    <div style={{ fontSize:8, color:"#3A3028", marginTop:2, lineHeight:1.5 }}>
                      {selUnit.type==="tall-single" ? "1 full-height door · 3 hinges" :
                       ...
                       selUnit.type==="tall-double-v" ? "2 side-by-side doors · L+R hinged" :
                    ...
                    <div style={{ display:"flex", alignItems:"center", gap:12 }}>
                      ...
                      <div>
                        <div style={{ fontSize:10, color:C.white, lineHeight:1.5 }}>
                          Your estimated layout price will display once your details have been submitted for final review and measurement by HWH Designs.
                        </div>
