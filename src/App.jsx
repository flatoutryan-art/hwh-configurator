        ...
        {showFinishes && (
          <div style={{ padding:"8px 10px" }}>
            ...
            <div style={{ marginTop:10, paddingTop:10, borderTop:`1px solid ${C.border}` }}>
              <button onClick={()=>{
                // Read the currently active runner from drawer units (not from selUnit which may be a door unit)
                // and the active hinge from door units — preserve what the user set via the fittings toggles
                setUnits(p => p.map(u => ({
                  ...u,
                ...
                fontSize:13, fontWeight:"bold", letterSpacing:1.5, textTransform:"uppercase", fontFamily:"inherit",
              }}>Apply to All Units</button>
            </div>
          </div>
        )}
      </div>
